...
[float]
=== Description
The keyboard functions enable 32u4 or SAMD micro based boards (such as the Arduino Leonardo or Arduino Nano) to send keystrokes to an attached computer through their micro's native USB port.
[%hardbreaks]
